...
input uint              InpSlippage          =  0;    // Slippage in pointsts)
...
input double inpSL= 40;// Stop Loss Value
double MaxSL                 = inpSL;
...
input bool Report=true;//Write Trade report in csv file

input bool WriteTradeAdviserReport =false;//Write TradeAdvisor report in csv file
input bool NewsReport=false;//Write news report in csv file
