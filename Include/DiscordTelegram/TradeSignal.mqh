...
public:
  ...
  int TradeSignal(  string indicatorNames,ENUMS_TIMEFRAMES timeframe,ENUMS_TIMEFRAMES timeframex,string indicatorNamesx,  string commentx1, int shiftn,int shiftx1, string symbol1){
  ...
  int sellx=(int)iCustom(symbol1,timeframex,indicatorNamesx,1,shiftx1);
